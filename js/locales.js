window.NM_LOCALES = {
  intl: { code:"intl", lang:"en", hreflang:"en", currency:"USD", currencySymbol:"$", path:"/",
    ...
    navLabels:{ measurable:"Measurable", roster:"Roster", brain:"The Brain", integrations:"Integrations", pricing:"Pricing", compare:"Compare", resources:"Resources", faq:"FAQ", signIn:"Sign in", startFree:"Start free" },
  ...
  es: { code:"es", lang:"es", hreflang:"es", currency:"EUR", currencySymbol:"€", path:"/es/",
    ...
    navLabels:{ measurable:"Medible", roster:"El equipo", brain:"El Brain", integrations:"Integraciones", pricing:"Precios", compare:"Comparativas", resources:"Recursos", faq:"Preguntas", signIn:"Iniciar sesión", startFree:"Prueba gratis" },
